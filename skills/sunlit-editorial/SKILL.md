...
description: "Generate coherent Sunlit Editorial editorial illustration sets using matte digital paint with optimistic visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Sunlit Editorial."
---

# Sunlit Editorial

Create a coherent set of article illustrations using the Sunlit Editorial visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

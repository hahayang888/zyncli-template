---
name: process-cutaway
description: "Generate coherent Process Cutaway editorial illustration sets with a reusable explainer visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need scientific editorial cutaway of an invented but coherent instrument whose chambers, filters, gates, and output path make one transformation inspectable."
---

# Process Cutaway

Create a coherent set of article illustrations with the Process Cutaway visual system. Draw an invented but mechanically coherent instrument in sectional view. Chambers, filters, gates, and output paths expose the transformation itself, combining technical authority with editorial economy.

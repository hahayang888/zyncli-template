---
name: charcoal-reportage
description: "Generate coherent Charcoal Reportage editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need urgent charcoal-and-graphite reportage showing credible adults connecting evidence and decisions inside a civic, operational, or investigative room."
---

# Charcoal Reportage

Create a coherent set of article illustrations with the Charcoal Reportage visual system. Observe adults connecting evidence, maps, documents, and decisions inside a civic or operational room. Broad charcoal masses and selective cobalt pencil preserve urgency without turning the scene into a polished office illustration.

---
name: pastel-threshold
description: "Generate coherent Pastel Threshold editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need atmospheric chalk-pastel editorial scenes with one small adult moving between turbulent and ordered spatial fields, using powder, smudge, and light to express transition."
---

# Pastel Threshold

Create a coherent set of article illustrations with the Pastel Threshold visual system. Place one small adult figure between turbulent and ordered pastel fields. Smudged edges, powdery light, and controlled color transitions make uncertainty, recovery, and change visible through atmosphere and movement.

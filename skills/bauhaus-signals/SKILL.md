---
name: bauhaus-signals
description: "Generate coherent Bauhaus Signals editorial illustration sets using geometric vector with bold visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Bauhaus Signals."
---

# Bauhaus Signals

Create a coherent set of article illustrations using the Bauhaus Signals visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

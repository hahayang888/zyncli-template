---
name: inclusive-monochrome
description: "Generate coherent Inclusive Monochrome editorial illustration sets using monochrome line with human visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Inclusive Monochrome."
---

# Inclusive Monochrome

Create a coherent set of article illustrations using the Inclusive Monochrome visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

---
name: felted-logic
description: "Generate coherent Felted Logic editorial illustration sets with a reusable 3d visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need a tactile textile explainer made from cut wool felt, embroidered junctions, and tensioned threads that physically construct a network or decision system."
---

# Felted Logic

Create a coherent set of article illustrations with the Felted Logic visual system. Explain pathways, dependencies, and coordination through cut felt, embroidered nodes, and tensioned thread. Every connection must behave like a physical textile construction rather than a decorative craft pattern.

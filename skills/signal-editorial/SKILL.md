...
description: "Generate coherent Signal Editorial editorial illustration sets using digital collage with confident visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Signal Editorial."
---

# Signal Editorial

Create a coherent set of article illustrations using the Signal Editorial visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

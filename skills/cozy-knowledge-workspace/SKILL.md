---
name: cozy-knowledge-workspace
description: "Generate coherent Cozy Knowledge Workspace editorial illustration sets using gouache & pencil with warm visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Cozy Knowledge Workspace."
---

# Cozy Knowledge Workspace

Create a coherent set of article illustrations using the Cozy Knowledge Workspace visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

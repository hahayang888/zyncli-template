---
name: ink-passage
description: "Generate coherent Ink Passage editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need contemporary ink-wash editorial abstraction where fragments, diluted fields, and one architectural passage make uncertainty and transition navigable."
---

# Ink Passage

Create a coherent set of article illustrations with the Ink Passage visual system. Use expressive black wash, diluted cobalt, and a single coral cue to transform fragments into passages, thresholds, and shelters. The style preserves ambiguity while giving the reader one unmistakable route through the idea.

---
name: signal-matrix
description: "Generate coherent Signal Matrix editorial illustration sets using digital collage with intelligent visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Signal Matrix."
---

# Signal Matrix

Create a coherent set of article illustrations using the Signal Matrix visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

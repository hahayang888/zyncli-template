---
name: glazed-mechanism
description: "Generate coherent Glazed Mechanism editorial illustration sets with a reusable 3d visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need approachable systems illustration built from hand-formed glazed ceramic gates, vessels, channels, and joints that perform one mechanically clear workflow."
---

# Glazed Mechanism

Create a coherent set of article illustrations with the Glazed Mechanism visual system. Build a believable working system from ceramic channels, gates, vessels, and joints. Glaze variation and hand-built edges humanize the mechanism, while physical routing keeps the explanation clear.

---
name: cutout-editorial-collage
description: "Generate coherent Cutout Editorial Collage editorial illustration sets using digital paper collage with sophisticated visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Cutout Editorial Collage."
---

# Cutout Editorial Collage

Create a coherent set of article illustrations using the Cutout Editorial Collage visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.
...
- decorative filler
- repeated claims
- paragraphs already concrete without a visual
...
- Preserve visual identity through material, palette, hierarchy, and composition grammar rather than repeating a scene.

---
name: human-lines
description: "Generate coherent Human Lines editorial illustration sets using ink & spot color with expressive visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Human Lines."
---

# Human Lines

Create a coherent set of article illustrations using the Human Lines visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

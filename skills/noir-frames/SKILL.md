---
name: noir-frames
description: "Generate coherent Noir Frames editorial illustration sets using ink & charcoal with tense visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Noir Frames."
---

# Noir Frames

Create a coherent set of article illustrations using the Noir Frames visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

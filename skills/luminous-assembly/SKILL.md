---
name: luminous-assembly
description: "Generate coherent Luminous Assembly editorial illustration sets with a reusable 3d visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need contemporary stained-glass editorial structure where distinct colored fragments lock into an architectural bridge, threshold, or orbit through meaningful lead-line geometry."
---

# Luminous Assembly

Create a coherent set of article illustrations with the Luminous Assembly visual system. Use contemporary stained glass, lead cames, transmitted light, and architectural suspension to show separate parts becoming a bridge, threshold, or orbit. Color follows structure rather than decoration.

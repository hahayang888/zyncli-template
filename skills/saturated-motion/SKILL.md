---
name: saturated-motion
description: "Generate coherent Saturated Motion editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need kinetic editorial illustration built from sweeping saturated color fields, one elongated adult figure, and a strong directional curve expressing momentum, pressure, or creative transformation."
---

# Saturated Motion

Create a coherent set of article illustrations with the Saturated Motion visual system. Build kinetic editorial scenes from large curved fields, one expressive adult figure, and a clear directional sweep. The style suits transformation and creative-work stories that need energy, while a limited shape grammar keeps saturation purposeful rather than decorative.

---
name: shadow-stage
description: "Generate coherent Shadow Stage editorial illustration sets with a reusable conceptual visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need handcrafted multi-layer black-paper shadow theatre in which fragmented silhouettes align into one bridge or passage through a controlled cobalt backlight."
---

# Shadow Stage

Create a coherent set of article illustrations with the Shadow Stage visual system. Build a handcrafted shadow theatre from cut silhouettes, visible depth layers, and one controlled cobalt light path. Fragmented actors or structures align into a bridge or passage, making hidden coordination legible without cinematic spectacle.

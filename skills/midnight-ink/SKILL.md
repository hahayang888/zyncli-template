---
name: midnight-ink
description: "Generate coherent Midnight Ink editorial illustration sets using ink & light with cinematic visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Midnight Ink."
---

# Midnight Ink

Create a coherent set of article illustrations using the Midnight Ink visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

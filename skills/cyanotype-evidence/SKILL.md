---
name: cyanotype-evidence
description: "Generate coherent Cyanotype Evidence editorial illustration sets with a reusable collage visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need archival cyanotype collage using prussian-blue photograms, solar exposure texture, and sparse coral stitched traces to connect pieces of evidence without becoming a formal diagram."
---

# Cyanotype Evidence

Create a coherent set of article illustrations with the Cyanotype Evidence visual system. Combine cyanotype silhouettes of architecture, botany, tools, and documents with sparse stitched connections. The result suits research-led writing that needs evidence, memory, and structure without becoming a literal diagram.

---
name: sculpted-characters
description: "Generate coherent Sculpted Characters editorial illustration sets using character 3d with warm visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Sculpted Characters."
---

# Sculpted Characters

Create a coherent set of article illustrations using the Sculpted Characters visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

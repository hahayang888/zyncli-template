...
description: "Generate coherent Editorial Portrait editorial illustration sets using cinematic photography with intimate visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Editorial Portrait."
---

# Editorial Portrait

Create a coherent set of article illustrations using the Editorial Portrait visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

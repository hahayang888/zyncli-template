---
name: glass-systems
description: "Generate coherent Glass Systems editorial illustration sets using glass & metal 3d with precise visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Glass Systems."
---

# Glass Systems

Create a coherent set of article illustrations using the Glass Systems visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

---
name: oil-allegory
description: "Generate coherent Oil Allegory editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need contemporary figurative oil allegory in which one restrained adult action—building, carrying, crossing, repairing—embodies the article's moral or strategic tension."
---

# Oil Allegory

Create a coherent set of article illustrations with the Oil Allegory visual system. Turn an argument into one staged symbolic action painted with restrained oil color and directional light. People build, carry, cross, or repair the metaphor so the image feels like an editorial commission, not a historical pastiche.

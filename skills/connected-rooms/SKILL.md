...
description: "Generate coherent Connected Rooms editorial illustration sets with a reusable workplace visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need warm modular workplace illustration showing several inhabited rooms linked by purposeful messages, shared objects, or repeated actions across one distributed human system."
---

# Connected Rooms

Create a coherent set of article illustrations with the Connected Rooms visual system. Turn remote work, community, and collaboration into a composed network of inhabited rooms. Each window contains one credible activity, while messages, shared objects, and spatial rhythm reveal the relationship across the whole system.

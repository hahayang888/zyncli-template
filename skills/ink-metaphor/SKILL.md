---
name: ink-metaphor
description: "Generate coherent Ink Metaphor editorial illustration sets using ink & watercolor with thoughtful visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Ink Metaphor."
---

# Ink Metaphor

Create a coherent set of article illustrations using the Ink Metaphor visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

---
name: media-vortex
description: "Generate coherent Media Vortex editorial illustration sets using painterly realism with immersive visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Media Vortex."
---

# Media Vortex

Create a coherent set of article illustrations using the Media Vortex visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

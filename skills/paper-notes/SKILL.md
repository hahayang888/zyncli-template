---
name: paper-notes
description: "Generate coherent Paper Notes editorial illustration sets using paper texture with reflective visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Paper Notes."
---

# Paper Notes

Create a coherent set of article illustrations using the Paper Notes visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

...
description: "Generate coherent Technical Field Notes editorial illustration sets using graphite & ink with analytical visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Technical Field Notes."
---

# Technical Field Notes

Create a coherent set of article illustrations using the Technical Field Notes visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

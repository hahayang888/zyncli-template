---
name: soft-objects
description: "Generate coherent Soft Objects editorial illustration sets using soft 3d with optimistic visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Soft Objects."
---

# Soft Objects

Create a coherent set of article illustrations using the Soft Objects visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

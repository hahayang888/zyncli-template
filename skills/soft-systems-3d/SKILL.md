---
name: soft-systems-3d
description: "Generate coherent Soft Systems 3D editorial illustration sets using tactile 3d with approachable visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Soft Systems 3D."
---

# Soft Systems 3D

Create a coherent set of article illustrations using the Soft Systems 3D visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

---
name: evidence-atlas
description: "Generate coherent Evidence Atlas editorial illustration sets using information design with authoritative visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Evidence Atlas."
---

# Evidence Atlas

Create a coherent set of article illustrations using the Evidence Atlas visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

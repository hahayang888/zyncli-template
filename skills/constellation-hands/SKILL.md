---
name: constellation-hands
description: "Generate coherent Constellation Hands editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need elegant symbolic editorial illustration using fine copper hand outlines and one concentrated constellation of amber particles to show stewardship, trust, influence, or collective intelligence."
---

# Constellation Hands

Create a coherent set of article illustrations with the Constellation Hands visual system. Build a dark, elegant editorial field where two or three outlined hands shape one meaningful constellation of particles. The style gives governance, care, influence, and invisible coordination a precise human scale without resorting to mystical spectacle.

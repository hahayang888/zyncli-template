---
name: gouache-field-notes
description: "Generate coherent Gouache Field Notes editorial illustration sets with a reusable illustration visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need observational editorial gouache with matte opaque color, simplified credible adults, pinned research material, and visible brush decisions focused on one act of inquiry."
---

# Gouache Field Notes

Create a coherent set of article illustrations with the Gouache Field Notes visual system. Build authored editorial scenes from matte gouache, simplified adults, pinned evidence, and visible brush texture. The style observes people thinking and testing ideas instead of presenting generic teamwork poses.

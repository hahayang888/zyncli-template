---
name: marbled-forces
description: "Generate coherent Marbled Forces editorial illustration sets with a reusable abstract visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need causal abstract marbling based on suminagashi and oil-pigment behavior, showing currents collide, redirect, and resolve into a calmer shared flow."
---

# Marbled Forces

Create a coherent set of article illustrations with the Marbled Forces visual system. Use suminagashi and oil-marbling logic to show currents colliding, separating, and resolving into a calmer shared flow. The style is abstract but causal: every swirl must reveal a force, not merely produce a beautiful pattern.

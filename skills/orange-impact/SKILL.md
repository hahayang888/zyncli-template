---
name: orange-impact
description: "Generate coherent Orange Impact editorial illustration sets using screen-print editorial with urgent visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Orange Impact."
---

# Orange Impact

Create a coherent set of article illustrations using the Orange Impact visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

---
name: clarity-diagrams
description: "Generate coherent Clarity Diagrams editorial illustration sets using vector system with clear visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Clarity Diagrams."
---

# Clarity Diagrams

Create a coherent set of article illustrations using the Clarity Diagrams visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

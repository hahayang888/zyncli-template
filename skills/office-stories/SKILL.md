---
name: office-stories
description: "Generate coherent Office Stories editorial illustration sets using flat illustration with human visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Office Stories."
---

# Office Stories

Create a coherent set of article illustrations using the Office Stories visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

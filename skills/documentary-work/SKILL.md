...
description: "Generate coherent Documentary Work editorial illustration sets using editorial photography with observant visual direction. Use when illustrating articles, blogs, newsletters, essays, or social posts in this named style, or when the user asks for reusable, consistent visuals matching Documentary Work."
---

# Documentary Work

Create a coherent set of article illustrations using the Documentary Work visual system. Preserve the style grammar across the set while inventing a fresh, article-specific composition for every image.

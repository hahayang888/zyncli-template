...
description: "Generate coherent Spatial Systems editorial illustration sets with a reusable infographic visual system. Use when illustrating articles, blogs, newsletters, essays, or social posts that need editorial spatial information illustration combining simplified maps, sections, routes, infrastructure, and small human figures into one legible service or mobility system."
---

# Spatial Systems

Create a coherent set of article illustrations with the Spatial Systems visual system. Combine simplified city sections, maps, routes, and people into a coherent editorial system. It is designed for mobility, logistics, public services, and infrastructure stories that need spatial clarity without resembling a dashboard or engineering plan.
